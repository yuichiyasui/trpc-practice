...
export type inferTransformedProcedureOutputOrVoid<
          ...
          ? {
              [K in $Value["_def"]["type"]]: (
                handler: ({
                  ...
                  inferTransformedProcedureOutputOrVoid<TRouter, $Value>
                >,
              ) => RequestHandler;
            }
          : never
...
export type MswTrpc<TRPCRouter extends AnyTRPCRouter> = ProcedureHandlerRecord<
  TRPCRouter,
  TRPCRouter["_def"]["record"]
>;
